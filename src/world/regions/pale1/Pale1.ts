...
const POSE_SPECS: readonly PoseSpec[] = [
  ...
  // The Seed Grove from the near rim, close and low: the mother's rose
  // face with the double nursery hedges crossing the frame's foreground.
  // (Round 6 tried the row's far end and a raised rim — the far side is
